...
found_exercises = MTMMM.find_exercises(templates,time_series=time_series, kabsch=False, max_iterations=1000, max_iterations_bad_match = 500, min_segment_length=0.5)
